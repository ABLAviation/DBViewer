...
{{--        </style>--}}
                        ...
                        <div class="col-6 d-flex justify-content-center">
                            <div class="search-form-wrapper">
                                <form action="GET">
                                    @csrf
                                    <div class="flex-row">
                                        <select class="select2" name="table" id="select-table">
    ...
    <script>
        ...
        $(function() {
            ...
            loadTable($('.select2').find(':selected').val());
            ...
            function loadTable(tableName){
                $.ajax({
                    ...
                    success:function(response) {
                        ...
                        let tableDOM = `<table id="view-table" class="table table-bordered">
                                            <thead></thead>
                                            <tbody></tbody>
                                        </table>`;
                        $('#view-table').remove()
